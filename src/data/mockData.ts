...
export interface Plan extends CityFilterable {
  ...
  features: string[];
  apps: Apps[]; // Aplicativos incluídos no plano
  isHighlight: boolean;
  isPremium: boolean;
  isVisible: boolean;
  color: string;
...
export const mockPlans: Plan[] = [
  ...
  },
  {
    ...
    apps: [
      {
        image: "/assets/planos/looke.webp",
        name: "Looke",
      },
      {
        image: "/assets/planos/max.webp",
        name: "MAX",
      },
    ],
    isHighlight: true,
  ...
  },
  {
    ...
    apps: [
      ...
      {
        image: "/assets/planos/deezer.webp",
        name: "Deezer",
      },
    ],
    isHighlight: false,
...
export const mockTestimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    comment:
      "Internet muito rápida e estável. O suporte é excelente, sempre me atenderam super bem quando precisei. Recomendo!",
    cities: ["1"], // São Paulo
  },
  {
    id: 2,
    ...
    rating: 5,
    comment:
      "Melhor custo-benefício da região! A velocidade é exatamente como prometido e nunca tive problemas.",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Migrei de outra operadora e a diferença é notável. Streaming em 4K sem travamentos!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Atendimento nota 10! A instalação foi rápida e o técnico muito profissional.",
    cities: ["4"], // Salvador
  },
  {
    id: 5,
    ...
    rating: 5,
    comment:
      "Finalmente uma internet que funciona de verdade! Trabalho home office e não tenho mais problemas.",
    cities: ["5"], // Fortaleza
  },
  {
    id: 6,
    ...
    rating: 5,
    comment:
      "Preço justo e qualidade excepcional. Toda família está satisfeita com o serviço.",
    cities: ["6"], // Brasília
  },
];
...
export const mockBlogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Descubra qual plano de internet é perfeito para suas necessidades e quantas pessoas vivem na sua casa.",
  ...
  },
  {
    ...
    excerpt:
      "Entenda as vantagens da fibra ótica e por que ela é superior às conexões tradicionais.",
    author: "Equipe CAS Internet",
    date: "2024-12-08",
    image: "/placeholder.svg",
    readTime: "7 min",
  ...
  },
  {
    ...
    excerpt:
      "Aprenda a posicionar seu roteador e configurar sua rede para ter a melhor performance.",
    author: "Equipe CAS Internet",
    date: "2024-12-05",
    image: "/placeholder.svg",
    readTime: "4 min",
...
export const mockCarouselSlides: CarouselSlide[] = [
  {
    ...
    description:
      "Planos a partir de R$ 59,90 com instalação gratuita e sem fidelidade",
    image: "/placeholder.svg",
    ctaText: "Ver Planos",
    ctaLink: "#planos",
    cities: ["1", "2", "3", "4", "5", "6", "7", "8"], // Todas as cidades
  },
  {
    ...
    description:
      "Contrate o plano Plus ou Premium e ganhe Netflix por 12 meses",
    image: "/placeholder.svg",
...
export function filterByCity<T extends CityFilterable>(
  items: T[],
  cityId: string
): T[] {
...
export function getAvailableCitiesForItem<T extends CityFilterable>(
  item: T,
  allCities: City[]
): City[] {
