          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto mb-16">
              {contactMethods.map((method, index) => (
                <ScrollReveal key={method.title} delayMs={index * 90} className="h-full">
                  <Card 
                    className={`text-center p-6 shadow-card hover:shadow-primary/10 transition-all duration-300 relative h-full ${
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {offices.map((office, index) => (
                <ScrollReveal key={office.city} delayMs={index * 100} className="h-full">
                  <Card className="p-6 shadow-card hover:shadow-primary/10 transition-all duration-300 h-full">
