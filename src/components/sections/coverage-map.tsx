  ...
  useEffect(() => {
    ...
    availableCities.forEach((city) => {
      ...
      const marker = L.marker(
        city.geolocalizacao ? city.geolocalizacao.split(",") : centerPosition,
        { icon: casIcon }
      ).addTo(map.current);
      ...
      const popupContent = `
        <div style="padding: 8px; min-width: 200px;">
          ...
          <div style="margin-bottom: 8px;">
            <h3 style="font-weight: 600; font-size: 14px; margin: 0 0 4px 0;">${
              city.cidade
            }</h3>
          </div>
          
          <div style="margin-bottom: 12px;">
            <p style="font-size: 12px; margin: 0; margin-bottom: 4px;">📍 Endereço: ${
              city.endereco_loja || "Não informado"
            }</p>
            <a href="https://maps.google.com/maps?q=${
              city.geolocalizacao
            }" target="_blank" rel="noopener noreferrer" style="font-size: 12px; margin: 0;">📍 Ver no Google Maps</a>
          </div>
        </div>
      `;
      ...
      <div className="container mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Nossa cobertura se estende por todo o Estado do Maranhão. Clique nos
            marcadores para ver os detalhes de cada cidade
          </p>
        </div>
